...
private const val KOREAN_NUMBER_ENGLISH_SPECIAL_SPACE_UNDER30_PATTERN =
    "^\$|^[0-9a-zA-Zㄱ-ㅣ가-힣/[\\{\\}\\[\\]\\/?.,;:|\\)*~`!^\\-_+<>@\$%&\\\\\\=\\(\\'\\\"#\\s]/g\\u318D\\u119E\\u11A2\\u2022\\u2025\\u00B7\\uFE55]{0,30}+$"
val KOREAN_NUMBER_ENGLISH_SPECIAL_SPACE_UNDER30_REGEX: Pattern =
    Pattern.compile(KOREAN_NUMBER_ENGLISH_SPECIAL_SPACE_UNDER30_PATTERN)
